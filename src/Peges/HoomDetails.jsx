      ...
      <div className="container mx-auto my-10 p-6 bg-white shadow-lg rounded-lg">
          ...
          <div className="lg:w-3/4">
            ...
            <p className="text-lg text-gray-700 mb-4">
              <strong>Subscription Price:</strong> ${singleHome.price}/month<br />
              <strong>  Frequency:</strong> {singleHome.category}<br />
              <strong>Category:</strong> {singleHome.ratting}
            </p>
              ...
              <div className="mb-4">
               <div className='bg-gray-300 shadow-2xs p-6 rounded-xl'>
                ...
                {comments.map((text,index)=>(
                    <div key={index} className=' bg-gray-100 m-1 rounded-xl px-3'>
                        <p className='flex items-center gap-3'><span className='font-semibold'>Ratting  : </span> {text.ratting} <BsStarFill className='text-amber-500  ' size={20}></BsStarFill></p>
                        <p><span className='font-semibold'>Review : </span>{text.comment}</p>
                    </div>
                ))}
                </div>
                </div>
